 ...
 *  v1.1.2:
 * 		2022-08-05 - fixed some code that generated warnings when compiling.
 *
 * ===============================================*/
...
// Used if the hardware has a wicked bit order.
#define TM1650_FIX_WICKED_BIT_ORDER
